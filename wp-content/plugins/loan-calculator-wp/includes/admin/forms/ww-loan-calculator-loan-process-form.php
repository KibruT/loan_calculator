...
<section class="heading-section">
    <div class="menu-sec-cls">
        <ul class="heading-sec-link" style="display:none;">
            <?php
...
<section id="main-sec">
    <section class="calculator-heading-section calculator-heading-block" style="display: none;">
    ...
    <section class="loan-option-text-info">
            ...
            <div class="loan-option-text-info-block">
                <div class="first-row">
                    <div class="first-row-sub-child">
                        ...
                        <input style="display: none;" type="range" min="<?php esc_attr_e( $loan_amount_min_value,'loan-calculator-wp' );?>" max="<?php esc_attr_e( $loan_amount_max_value,'loan-calculator-wp' );?>" value="<?php esc_attr_e( $loan_amount,'loan-calculator-wp' );?>" class="slider" id="loan_amount_range" tabindex="3" step="1000">
                    </div>
                    <div class="first-row-sub-child">
                        ...
                        <input style="display: none;" type="range" min="<?php esc_attr_e( $loan_term_min_value,'loan-calculator-wp' );?>" max="<?php esc_attr_e($loan_term_max_value,'loan-calculator-wp');?>" value="<?php esc_attr_e($loan_term,'loan-calculator-wp');?>" class="slider" id="loan_terms_range" tabindex="6" step="1">
                    </div>
                    <div class="first-row-sub-child">
                         <?php 
                                    if( $disable_repayment_frequency != 1){
                            ?>
                        <div class="first-row-main-child" style="display: none;">
                ...
                <div class="second-row">
                    <div class="second-row-sub-child">
                        ...
                        <input style="display: none;" type="range" min="<?php esc_attr_e( $interest_rate_min_value,'loan-calculator-wp' );?>" max="<?php esc_attr_e( $interest_rate_max_value,'loan-calculator-wp' );?>" value="<?php esc_attr_e($interested_rate,'loan-calculator-wp');?>" class="slider" id="interest_rate_range" tabindex="10" step="0.25">
                    </div>
                    <?php if ( $disable_ballon_amt == 1){ ?>
                    <div class="second-row-sub-child" style="display: none;">
                       
                        <div class="loan-text-dis">
                            <input  ntype="hidden"ame="ballon_amounts" id="ballon_amounts" value="" tabindex="11" onkeydown="return onlyNos(event,'ballon_amounts')"/>
        ...
        <div  class="loan-detail-section <?php esc_attr_e( $full_width_cls );?>">
            <div class="loan-detail-section-child" style="display: none;">
                <div class="sub-main-tab">
                    ...
                    <div class="tabs">
                        ...
                        <?php
                            if( $enable_repayment_chart == 1 ) {
                        ?>
                        <input hidden type="radio" name="tabs" id="tab1" <?php esc_attr_e($tab1_checked);?>>
                        <label for="tab1">
            ...
            <div class="loan-detail-cal-desc">
                ...
                <div class="loan-cal-desc">
                    ...
                    <div class="loan-cal-desc" id="ballon_amt_section">
                        <div class="loan-cal-desc-heading" style="display: none;">
                        ...
                        <div class="loan-cal-desc-val" style="display: none;">
    ...
    <?php if ( $disable_contactus_section == ""){ ?>
         <div class="contact-us-section" style="display: none;">
    ...
    <div class="calculator-disclaimer-section" style="display: none;">
